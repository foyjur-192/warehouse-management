...
const BedInventory = () => {
    ...
    const handleSubmit = async (event) => {
     ...
     const {data} = await axios.post('https://floating-sea-17167.herokuapp.com/bedInventory', inventory);
     ...
     toast.success(data.message);
       ...
       const handleDelete = id => {
        fetch(`https://floating-sea-17167.herokuapp.com/bedInventory/${id}` ,{
            method:'DELETE'
        })
        .then((result) => {
        ...
        useEffect (() => {
     const url = `https://floating-sea-17167.herokuapp.com/bedInventory`;
     fetch(url)
     .then(res => res.json())
