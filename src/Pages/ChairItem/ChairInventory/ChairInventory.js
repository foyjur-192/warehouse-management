...
const ChairInventory = () => {
    ...
    const handleSubmit = async (event) => {
     ...
     const {data} = await axios.post('https://floating-sea-17167.herokuapp.com/chairinventory', inventory);
     ...
     toast.success(data.message);
       ...
       const handleDelete = id => {
        fetch(`https://floating-sea-17167.herokuapp.com/chairinventory/${id}` ,{
            method:'DELETE'
        })
        .then((result) => {
        ...
        useEffect (() => {
     const url = `https://floating-sea-17167.herokuapp.com/chairinventory`;
     fetch(url)
     .then(res => res.json())
...
<div className='mother-container container'>
