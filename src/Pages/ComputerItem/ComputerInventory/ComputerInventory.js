...
const ComputerInventory = () => {
    ...
    const handleSubmit = async (event) => {
     ...
     const {data} = await axios.post('https://floating-sea-17167.herokuapp.com/computerInventory', inventory);
     ...
     toast.success(data.message);
       ...
       const handleDelete = id => {
        fetch(`https://floating-sea-17167.herokuapp.com/computerInventory/${id}` ,{
            method:'DELETE'
        })
        .then((result) => {
        ...
        useEffect (() => {
     const url = `https://floating-sea-17167.herokuapp.com/computerInventory`;
     fetch(url)
     .then(res => res.json())
