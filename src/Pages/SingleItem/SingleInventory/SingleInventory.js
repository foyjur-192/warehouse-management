...
const SingleInventory = () => {
    ...
    const handleSubmit = async (event) => {
     ...
     const {data} = await axios.post('https://floating-sea-17167.herokuapp.com/singleInventory', inventory);
     ...
     if (!data.success){
       ...
       const handleDelete = id => {
        fetch(`https://floating-sea-17167.herokuapp.com/singleInventory/${id}` ,{
            method:'DELETE'
        })
        .then((result) => {
        ...
        useEffect (() => {
     const url = `https://floating-sea-17167.herokuapp.com/singleInventory`;
     fetch(url)
     .then(res => res.json())
