...
const TableInventory = () => {
    ...
    const handleSubmit = async (event) => {
     ...
     const {data} = await axios.post('https://floating-sea-17167.herokuapp.com/tableInventory', inventory);
     ...
     toast.success(data.message);
       ...
       const handleDelete = id => {
        fetch(`https://floating-sea-17167.herokuapp.com/tableInventory/${id}` ,{
            method:'DELETE'
        })
        .then((result) => {
        ...
        useEffect (() => {
     const url = `https://floating-sea-17167.herokuapp.com/tableInventory`;
     fetch(url)
     .then(res => res.json())
